...
namespace Coffe_Shop
{
    public partial class Form1 : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            CategoriesLeftPanelControls.AddButtons("T� Gjitha", 0);
        ...
        public void Events(int Tag)
        {
            ...
            switch (Tag)
            {
                ...
                case 5:
                    ...
                    {
                        MessageBox.Show("Ju lutem kyquni n� sistem...", "Gabim", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    break;
                case 6:
        ...
        private void LoadUser(int IdUser)
        {
            ...
            switch (IdUser)
            {
                ...
                case 8:
                    ...
                    // Shfaq ContextMenuStrip n� pozicionin e llogaritur
        ...
        private void btnPastroTiketen_Click(object sender, EventArgs e)
        {
            ...
            FormParentElements.lblTavolina.Text = "Nuk ka tavolin�";
        ...
        private void btnKyqu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Ju lutem kontrolloni fush�n e ID-s.", "Gabim", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private async Task GetEmployId()
        {
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    MessageBox.Show("Puntori me k�t� ID Kart nuk ekziston. Ju lutem kotaktojeni Administratorin", "Gabim", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                txtTextCalculator.Text = "0";
                ...
                {
                    MessageBox.Show("Puntori me k�t� ID Kart �sht� deaktiv. Ju lutem kotaktojeni Administratorin", "Llogaria Deaktive", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            try
            {
                if (FormParentElements.lblTavolina.Text == "Nuk ka tavolin�")
                {
                    MessageBox.Show("Ju lutem zgjedheni tavolin�n p�r porosi!", "Kujdes", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        {
            DialogResult drs = MessageBox.Show("D�shiron t� mbyll�sh aplikacionin ?", "Pyetje", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
